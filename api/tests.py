...
from .models import Customer, Token, Business, BusinessCategory, County, Ward, Area, SubCounty
import json
...
class CustomerViewTests(TestCase):
    ...
    def test_update_customer(self):
        ...
        response = self.client.put(
            reverse("api:customer", args=[customer.ulid]),
    ...
    def test_send_link_for_delete_customer_when_requested_from_customer(self):
        ...
        self.client.credentials(Authorization=f"Bearer {customer_token}")
        response = self.client.put(
            reverse("api:request_delete_customer", args=[customer.ulid]),
...
class BusinessViewTests(TestCase):
    ...
    def test_get_businesses(self):
        ...
        response = self.client.get(reverse("api:businesses"))
        # print_response(response)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_delete_business(self):
        ...
        self.client.credentials(Authorization=f"Bearer {self.admin_token}")
        response = self.client.delete(reverse("api:business", args=[business.ulid]))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_get_business_customers(self):
        ...
        response = self.client.get(reverse("api:business_customers", args=[business.ulid]))
        # print_response(response)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data["body"]), 15)

    def test_get_business_customers_with_invalid_business(self):
        response = self.client.get(reverse("api:business_customers", args=["invalid"]))
        # print_response(response)
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
...
class BusinessCategoryTests(TestCase):
    ...
    def test_create_business_category(self):
        ...
        response = self.client.post(
            reverse("api:business_categories"),
            data=json.dumps(data),
            content_type="application/json",
        )
        # print_response(response)
    ...
    def test_get_business_categories(self):
        ...
        response = self.client.get(reverse("api:business_categories"))
        # print_response(response)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data["body"]), 15)
...
class CountyTest(TestCase):
    ...
    def test_get_counties(self):
        ...
        response = self.client.get(reverse("api:counties"))
        # print_response(response)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data["body"]), 15)
...
class SubCountyTest(TestCase):
    ...
    def test_create_sub_county(self):
        ...
        response = self.client.post(
            reverse("api:subcounties", args=[self.county.name]),
            data=json.dumps(data),
            content_type="application/json",
        )
        # print_response(response)
    ...
    def test_get_sub_counties(self):
        ...
        response = self.client.get(reverse("api:subcounties", args=[self.county.name]))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data["body"]), 15)
...
class WardTest(TestCase):
    ...
    def test_create_ward(self):
        ...
        response = self.client.post(
            reverse("api:wards", args=[self.county.name, self.sub_county.name]),
            data=json.dumps(data),
            content_type="application/json",
        )
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_get_wards(self):
        ...
        response = self.client.get(reverse("api:wards", args=[self.county.name, self.sub_county.name]))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data["body"]), 15)
...
class AreaTest(TestCase):
    ...
    def test_create_area(self):
        ...
        response = self.client.post(
            reverse("api:areas", args=[self.county.name, self.sub_county.name, self.ward.name]),
            data=json.dumps(data),
            content_type="application/json",
        )
        # print_response(response)
    ...
    def test_get_areas(self):
        ...
        response = self.client.get(reverse("api:areas", args=[self.county.name, self.sub_county.name, self.ward.name]))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data["body"]), 15)
